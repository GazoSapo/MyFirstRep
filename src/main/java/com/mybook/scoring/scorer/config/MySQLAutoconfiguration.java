package com.mybook.scoring.scorer.config;
...
public class MySQLAutoconfiguration {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/leagues?createDatabaseIfNotExist=true&&serverTimezone=UTC");
        dataSource.setUsername("root");
        dataSource.setPassword("Qwerty09");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.mybook.scoring.scorer");
